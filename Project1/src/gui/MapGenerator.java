...
public class MapGenerator extends Application {
	...
	public void start(Stage primaryStage) {
		...
		this.primaryStage.setTitle("Heuristic Search");
	...
	public void initGUI() {
		try {
			...
			loader.setLocation(MapGenerator.class.getResource("view/gui.fxml"));
	...
	public void insertGridOptions() {
		try {
			//Load the layout file
			FXMLLoader loader = new FXMLLoader();
			loader.setLocation(MapGenerator.class.getResource("view/GridOptions.fxml"));
	...
	public void insertCellDisplayTable() {
		...
		try {
			//Load the layout file
			FXMLLoader loader = new FXMLLoader();
			loader.setLocation(MapGenerator.class.getResource("view/CellDisplay.fxml"));
			StackPane stack = (StackPane) loader.load();
